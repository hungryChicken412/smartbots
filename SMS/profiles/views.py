...
from .models import Profile, ChatbotProfile, chatlog, faq
from .forms import ProfileModelForm
from .serializers import ProfileSerializer, ChatbotTalkSerializer
...
class ChatbotTalkViewSet(viewsets.ModelViewSet):
	serializer_class = ChatbotTalkSerializer
	
	def get_queryset(self):
		tokenn = self.kwargs.get('token')
		chatbot = ChatbotProfile.objects.filter(token=tokenn)
		return chatbot
